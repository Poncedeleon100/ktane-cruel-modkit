...
const PolygonalMappingImgIndexes = [
    ...
    "img/The Cruel Modkit/ayin.png",
    "img/The Cruel Modkit/brackets.png",
    "img/The Cruel Modkit/ethiopic.png",
    "img/The Cruel Modkit/katakana.png",
    "img/The Cruel Modkit/pi.png",
    "img/The Cruel Modkit/reversee.png",
    "img/The Cruel Modkit/rparagraph.png",
    "img/The Cruel Modkit/rune.png",
    ...
    "img/The Cruel Modkit/tamil.png",
    "img/The Cruel Modkit/theta.png",
    "img/The Cruel Modkit/triquetra.png",
    "img/The Cruel Modkit/yi.png",
    "img/The Cruel Modkit/yo.png"
];